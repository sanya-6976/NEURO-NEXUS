...
const AIChat = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50 font-sans overflow-hidden">
      ...
      {/* Input Area */}
      <div className="bg-white border-t border-slate-100 p-4 md:p-8 animate-in slide-in-from-bottom-10 duration-700">
        ...
        <div className="relative max-w-5xl mx-auto flex items-center gap-4">
          <div className="relative flex-1 group">
            <input
              ...
              className="w-full pl-8 pr-16 py-6 bg-slate-50 border-2 border-slate-100 rounded-[2.5rem] text-xl font-bold focus:bg-white focus:border-blue-500 transition-all outline-none shadow-inner"
            />
          ...
          <button
            onClick={() => handleSend()}
            disabled={!input.trim()}
            className="w-20 h-20 bg-blue-600 text-white rounded-[2rem] flex items-center justify-center shadow-xl shadow-blue-200 hover:bg-blue-700 hover:scale-105 active:scale-95 transition-all disabled:opacity-50 disabled:grayscale"
          >
            <Send size={32} />
          </button>
        </div>
