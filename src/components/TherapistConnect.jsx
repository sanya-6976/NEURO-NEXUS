          ...
          <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-10">
            <div>
              <div className="flex items-center gap-4 mb-3">
                 ...
                 <h1 className="text-5xl font-black text-slate-900 tracking-tight">Therapist Connect</h1>
              </div>
              <p className="text-2xl text-slate-500 font-medium font-sans">Professional guidance, anytime, anywhere.</p>
            </div>
            <button 
              onClick={() => setSessionActive(true)}
              className="group relative px-10 py-5 bg-indigo-600 hover:bg-indigo-700 text-white text-2xl font-black rounded-3xl shadow-[0_10px_40px_rgba(79,70,229,0.3)] transition-all transform hover:scale-105 active:scale-95 flex items-center gap-4 overflow-hidden"
            >
