...
function App() {
  ...
  const streak = 12 + Math.floor(completedTasks.length / 3);
          ...
          <main className="flex-1 overflow-y-auto relative">
            ...
            <header className="lg:hidden bg-slate-900 text-white p-4 flex justify-between items-center sticky top-0 z-40 shadow-lg">
              <div className="flex items-center gap-3">
                <button onClick={toggleSidebar} className="p-2 hover:bg-white/10 rounded-xl transition-colors focus:ring-4 focus:ring-amber-400">
