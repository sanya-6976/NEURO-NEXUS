...
const TherapyPlanner = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6 md:p-12 flex flex-col items-center justify-start font-sans">
      ...
      <div className="text-center mb-10 w-full animate-in fade-in zoom-in-95 duration-700">
        <div className="inline-flex items-center justify-center gap-4 mb-3">
          ...
          <h2 className="text-5xl md:text-6xl font-black text-slate-900 tracking-tight italic">AI Therapy Planner</h2>
        </div>
        <p className="text-xl text-slate-500 font-medium">Create a smart session tailored to your child's needs.</p>
      </div>
          ...
          {step === 3 && generatedPlan && (
            ...
            >
              ...
              <div className="flex flex-col md:flex-row gap-4 pt-6">
                 <button 
                   onClick={() => setStep(1)}
                   className="flex-1 px-10 py-6 bg-white text-slate-900 border-4 border-slate-200 rounded-[2rem] font-black text-2xl hover:bg-slate-50 transition-all flex items-center justify-center gap-4"
                 >
                   <ChevronLeft /> EDIT PROFILE
                 </button>
                 <button 
                   onClick={startSession}
                   className="flex-[2] px-10 py-6 bg-indigo-600 text-white rounded-[2rem] font-black text-2xl hover:bg-indigo-700 shadow-2xl transition-all transform hover:scale-[1.02] flex items-center justify-center gap-4 group"
                 >
