  ...
  return (
    <div className="p-6 md:p-10 max-w-6xl mx-auto space-y-10 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div>
          <p className="text-xl font-bold text-slate-400 uppercase tracking-widest mb-1">{greeting}</p>
          ...
          <p className="text-xl text-slate-500 font-medium mt-3 max-w-lg">
            Let's keep up the great work today. You're doing amazing!
          </p>
        </div>

        {/* Status badge */}
        <div className={`flex items-center gap-3 px-6 py-4 rounded-2xl border-2 font-bold text-lg flex-shrink-0 ${
      ...
      <div className="relative bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-900 rounded-3xl p-8 md:p-10 overflow-hidden text-white">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <button onClick={() => navigate('/ai-hub')}
            className="flex-shrink-0 flex items-center gap-3 px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-black rounded-2xl text-lg transition-all hover:scale-105 shadow-lg shadow-blue-500/20">
