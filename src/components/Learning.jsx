...
const SubjectCard = ({ subject, onSelect, isCompleted }) => (
  <button
    ...
    className={`relative w-full text-left rounded-[2rem] p-8 bg-white border-2 ${subject.border} shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group overflow-hidden focus:outline-none focus:ring-4 focus:ring-offset-4 focus:ring-blue-400`}
  >
    ...
    <p className="text-slate-500 font-medium text-lg">{subject.items.length} lessons inside</p>
    {isCompleted && (
      ...
      <header className="mb-14 space-y-6">
        <div className="flex items-start justify-between flex-wrap gap-6">
          <div>
            ...
            <p className="text-2xl text-slate-500 font-medium mt-4 max-w-2xl">
              Big, fun, and easy lessons — just for you! Tap a subject to start learning.
            </p>
          </div>
          <div className="bg-white rounded-3xl p-6 shadow-lg border-2 border-slate-100 min-w-[200px]">
